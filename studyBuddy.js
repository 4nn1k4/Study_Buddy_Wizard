...
var vocabList = [
    ...
    new Vocab(2, "accumulate", "Waste must not be allowed to accumulate in working areas.", "To accumulate means to gather or pile up especially little by little", "Synonyms to accumulate are to build up, increase or expand", " antonyms to accumulate are lessen, diminish or decrease", "Accumulate originates from the Latin word, accumulāre, which means to heap up, add to or increase"),
    ...
    new Vocab(6, "rectify", "I had not meant to cause trouble, and asked what I could do to rectify the situation", "To rectify means to correct something or make something right", " synonyms of to rectify are to correct and amend", "Antonyms of to rectify are to damage, harm or hurt", "Rectify originates from the Latin word, rectus, which means right"),
    ...
    new Vocab(8, "feasible", "looking for a feasible way to create new jobs", "feasible means to be possible or capable to do something successfully", " syonyms to feasible are achievable, doable and possible", " antonyms to feasible are hopeless, impossible and undoable", "Feasible comes from faire, the French verb meaning, to do"),
    new Vocab(9, "name", "sen", "mean", "h1", "h2", "h3"),
    new Vocab(10, "alleged", "She allegedly stole the money, but we do not have evidence", "alleged means to be accused but not proven or convicted", "Synonyms to alleged are assumed, presumed and unproven", "Antonyms to alleged are actual, factual and real", "Alleged comes from the Latin word, allegare, which means to bring forth. to allege was therefore used to describe making a formal declaration in court"),
    new Vocab(11, "adverse", "This warning message causes no adverse impacts to end users, and can be ignored.", "adverse means to be harmful or likely to cause problems", "Synonyms to adverse are disadvantageous, hostile and negative", "Antonyms to adverse sind advantageous, favorable and positive", "adverse comes from the latin word, adversus, which means to turn toward, facing opposed"),
    new Vocab(12, "detrimental", "Former President Donald Trump was scheduled to hold a press conference today, but canceled after advisers warned the event could be detrimental to him and other Republicans", "detrimental means an undesirable or harmful person or thing", " synonyms to detrimental are bad, damaging and harmful", "Antonyms to detrimental are harmless, hurtless and inoffensive", "detrimental comes from the latin word, detere, which means to weaken or impair"),
    new Vocab(13, "quaint", "The antique shop was full of quaint things.", "quaint means to be attrectively unusual or old-fashioned", "Synonyms to quaint are bizarre, crazy and funky", "Antonyms to quaint are average, ordinary and typical", "quaint comes from the latin word cognitus, of cognoscere, which means to know"),
    new Vocab(14, "endow", "People think Jefferson was endowed with great wisdom. or, The state of Michigan has endowed three institutes", "Endow means to provide something freely or naturally or to give a large amount of money to pay for example for a college or hospital", "If someone or something is endowed with a particular quality or feature, the person or thing naturally has that quality or feature", "Synonyms to endow are to bless, favor or gift", "Antonyms to endow are dispossess, deplete or drain"),
    new Vocab(15, "serene", "Earth is still there, peaceful and serene as ever.", "serene means calm and peaceful", "serene comes from the latin word, serenus, which means clear, cloudless or troubles", "Synonyms to serene are calm, peaceful and quiet", "Antonyms to serene are loud, noisy and tumultuous"),
    new Vocab(16, "deter", "High prices deter many young people from entering the property market.", "To deter means to prevent someone from doing something or to make someone less enthusiastic about doing something by making it difficult for that person to do it or by threatening bad results if they do it", "to deter comes from the latin word, terrere, which means to frighten", "Antonyms to deter are encourage or persuade", "Synonyms to deter are discourage, dissuade or inhibit"),
    new Vocab(17, "scrutiny", "The government's record will be subjected to come under scrutiny in the weeks before the election", "scrutiny means a careful and detailed examination of something in order to get information about it", "scrutiny comes from the latin word, scrutinum, which means to search or examine", "Synonyms to scrutiny are checkup, examination or inspection", "Antonyms to scrutiny are glance, glimpse or peek"),
    new Vocab(18, "famine", "Because of the food shortage, the area was plagued by famine", "famine means a situation in which there is not enough food for a great number of people, causing illness and death, or a particular period when this happens", "famine comes from the latin word, fames, which means hunger or starvation", "Synonyms to famine are drought or deficiency", "Antonyms to famine are abundance, plenty or sufficiency"),
    new Vocab(19, "adjacent", "The other group is meeting in the adjacent room", "adjacent means being close or near, having a common endpoint or border", "Synonyms to adjacent are bordering, touching or joining", "Antonyms to adjacent are apart, detached or disconnected", "adjacent comes from the latin word, adjacere, which means to lie near, to border on"),
    new Vocab(20, "surplus", " There is a surplus of workers and not enough jobs.", "surplus is an amount that is more than needed", "surplus comes from the latin word superplus, which combines super and plus, which means more", "Synonyms to surplus are excess or overflow", "Antonyms of surplus are undersupply, deficit or insufficiency"),
