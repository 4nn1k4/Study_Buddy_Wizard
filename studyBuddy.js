...
var vocabList = [
    new Vocab(1, "itinerary", "The tour operator will arrange transport and plan your itinerary.", "itinerary means a rout or proposed route of a journey or a guidebook for travelers", "Synonyms for itinerary are route, path, travel guidebook or travel plan", "Itinerary is a detailed plan for a journey, especially a list of places to visit, a plan for traveling.", "itinerary comes from the latin word itierarium is a guidebook of the roman travelroutes"),
    ...
    new Vocab(3, "solicitor", "The family solicitors said the legal fight had been dropped because of costs to the taxpayer.", "a solicitor is a lawyer who advises clients on matters of law, draws up legal documents, prepares cases forbarristers and may represent clients in certain courts", "Synonyms for solicitor are lawyer and attorney", "Antonyms for solicitor are law breaker or scofflaw", "solicitor comes from the latin word sollicitator used in roman times for lawyers"),
    ...
    new Vocab(5, "liability", "She must accept liability for the damage.", "liability means the fact that someone is legally responsible for something, has an financial obligation, or has a hindrance or disadvantage", "Syonyms for liability are responsibility, obligation, handicap or downside", "Antonyms for liability are asset, advantage or plus", "Liability is often used in context with finances, legal cases and claims"),
    ...
    new Vocab(9, "surge", "There has been a surge in house prices recently.", "A surge is a sudden and great increase", "Synonyms for surge are increase, rise, gain or boost", "Antonyms for surge are decrease, diminish or lessen", "surge comes from the latin word surgere which means to rise, spring up"),
