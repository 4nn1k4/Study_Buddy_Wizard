...
var vocabList = [
    ...
    new Vocab(2, "accumulate", "Waste must not be allowed to accumulate in working areas.", "To accumulate means to gather or pile up especially little by little", "Synonyms for accumulate are to build up, increase or expand", " antonyms to accumulate are lessen, diminish or decrease", "Accumulate originates from the Latin word, accumulāre, which means to heap up, add to or increase"),
    ...
    new Vocab(11, "adverse", "This warning message causes no adverse impacts to end users, and can be ignored.", "adverse means to be harmful or likely to cause problems", "Synonyms for adverse are disadvantageous, hostile and negative", "Antonyms to adverse sind advantageous, favorable and positive", "adverse comes from the latin word, adversus, which means to turn toward, facing opposed"),
    new Vocab(12, "detrimental", "Former President Donald Trump was scheduled to hold a press conference today, but canceled after advisers warned the event could be detrimental to him and other Republicans", "detrimental means an undesirable or harmful person or thing", " Synonyms for detrimental are bad, damaging and harmful", "Antonyms to detrimental are harmless, hurtless and inoffensive", "detrimental comes from the latin word, detere, which means to weaken or impair"),
    new Vocab(13, "quaint", "The antique shop was full of quaint things.", "quaint means to be attrectively unusual or old-fashioned", "Synonyms for quaint are bizarre, crazy and funky", "Antonyms to quaint are average, ordinary and typical", "quaint comes from the latin word cognitus, of cognoscere, which means to know"),
    ...
    new Vocab(15, "serene", "Earth is still there, peaceful and serene as ever.", "serene means calm and peaceful", "serene comes from the latin word, serenus, which means clear, cloudless or troubles", "Synonyms for serene are calm, peaceful and quiet", "Antonyms to serene are loud, noisy and tumultuous"),
    new Vocab(16, "deter", "High prices deter many young people from entering the property market.", "To deter means to prevent someone from doing something or to make someone less enthusiastic about doing something by making it difficult for that person to do it or by threatening bad results if they do it", "to deter comes from the latin word, terrere, which means to frighten", "Antonyms to deter are encourage or persuade", "Synonyms for deter are discourage, dissuade or inhibit"),
    new Vocab(17, "scrutiny", "The government's record will be subjected to come under scrutiny in the weeks before the election", "scrutiny means a careful and detailed examination of something in order to get information about it", "scrutiny comes from the latin word, scrutinum, which means to search or examine", "Synonyms for scrutiny are checkup, examination or inspection", "Antonyms to scrutiny are glance, glimpse or peek"),
    new Vocab(18, "famine", "Because of the food shortage, the area was plagued by famine", "famine means a situation in which there is not enough food for a great number of people, causing illness and death, or a particular period when this happens", "famine comes from the latin word, fames, which means hunger or starvation", "Synonyms for famine are drought or deficiency", "Antonyms to famine are abundance, plenty or sufficiency"),
    new Vocab(19, "adjacent", "The other group is meeting in the adjacent room", "adjacent means being close or near, having a common endpoint or border", "Synonyms for adjacent are bordering, touching or joining", "Antonyms to adjacent are apart, detached or disconnected", "adjacent comes from the latin word, adjacere, which means to lie near, to border on"),
    new Vocab(20, "surplus", " There is a surplus of workers and not enough jobs.", "surplus is an amount that is more than needed", "surplus comes from the latin word superplus, which combines super and plus, which means more", "Synonyms for surplus are excess or overflow", "Antonyms of surplus are undersupply, deficit or insufficiency"),
    ...
    new Vocab(26, "embonpoint", "A person who is sufficiently fat so as to have a pleasing fullness of figure is embonpoint like a chubby child", "embonpoint means a plumpness of a person which is sufficient to be pleasant", "embonpoint comes from the the french phrase, en, bon, point, which means, in good condition", "Synonyms for embonpoint are plumpness or roundness", "Antonyms to embonpoint are leanness, slimness or thinness"),
    new Vocab(27, "tenebrous", "It's a tenebrous night with no moon", "tenebrous means shut off from the light, gloomy, shadowy or dark", "tenebrous comes from the latin word, tenebrae, which means darkness", "Synonyms for tenebrous are dark or obscure", "Antonyms to tenebrous are bright or illuminated"),
